...
public class PayloadGenerator {
    public static String generatePayload(String gadget,String cmd, String classFile, String encode, String mem, String password) throws Exception {
        String result = null;
        ...
        if (gadget != null) {
            ...
            gadgetObject = GadgetFactory.Utils.getGadgetObject(gadgetClass, classFile, cmd, mem, password);
