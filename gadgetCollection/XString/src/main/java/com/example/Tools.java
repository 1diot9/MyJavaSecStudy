...
public class Tools {
    ...
    public static Hashtable<Object, Object> makeTable (Object v1, Object v2 ) throws Exception {
        Hashtable<Object, Object> table = new Hashtable<>();
        setFieldValue(table, "count", 2);
        Class<?> nodeC;
        nodeC = Class.forName("java.util.Hashtable$Entry");
        Constructor<?> declaredConstructor = nodeC.getDeclaredConstructor(int.class, Object.class, Object.class, nodeC);
        declaredConstructor.setAccessible(true);
        Object tbl = Array.newInstance(nodeC, 2);
        Array.set(tbl, 0, declaredConstructor.newInstance(0, v1, v2, null));
        Array.set(tbl, 1, declaredConstructor.newInstance(0, v2, v1, null));
